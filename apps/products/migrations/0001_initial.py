    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("taste_tag", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="products.tastetag")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["user", "expires_at"], name="products_pr_user_id_33096b_idx"),
                    models.Index(fields=["recommendation_type", "-score"], name="products_pr_recomme_7b8258_idx"),
                ],
