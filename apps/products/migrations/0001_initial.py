    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ingredients",
                    models.TextField(help_text="주요 원료 (쌀, 누룩, 물 등)"),
                ),
                (
                    "alcohol_content",
                    models.FloatField(
                ...
                (
                    "stock_quantity",
                    models.IntegerField(default=0, help_text="재고 수량"),
                ),
                (
                    "min_stock_alert",
                    models.IntegerField(default=10, help_text="최소 재고 알림 기준"),
                ),
                (
                    "sweetness_level",
                    models.FloatField(
                ...
                (
                    "is_gift_suitable",
                    models.BooleanField(default=False, help_text="선물용 적합"),
                ),
                (
                    "is_award_winning",
                    models.BooleanField(default=False, help_text="주류 대상 수상작"),
                ),
                (
                    "is_regional_specialty",
                    models.BooleanField(default=False, help_text="지역 특산주"),
                ),
                (
                    "flavor_notes",
                    models.CharField(
                ...
                (
                    "short_description",
                    models.CharField(blank=True, help_text="간단 설명", max_length=200),
                ),
                (
                    "package_name",
                    models.CharField(blank=True, help_text="패키지명", max_length=100),
                ),
                (
                    "is_limited_edition",
                    models.BooleanField(default=False, help_text="한정판 여부"),
                ),
                (
                    "is_premium",
                    models.BooleanField(default=False, help_text="프리미엄 제품 여부"),
                ),
                (
                    "is_organic",
                    models.BooleanField(default=False, help_text="유기농 여부"),
                ),
                (
                    "similarity_vector",
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="유사도 계산용 벡터 (캐시용)",
                    ),
                ),
                (
                    "recommendation_score",
                    models.FloatField(default=0.0, help_text="기본 추천 점수"),
                ),
                ...
                (
                    "is_featured",
                    models.BooleanField(default=False, help_text="추천 제품 여부"),
                ),
                (
                    "launch_date",
                    models.DateField(blank=True, help_text="출시일", null=True),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="products_pr_user_id_33096b_idx",
                    ),
                    models.Index(
                        fields=["recommendation_type", "-score"],
                        name="products_pr_recomme_7b8258_idx",
                    ),
                ],
